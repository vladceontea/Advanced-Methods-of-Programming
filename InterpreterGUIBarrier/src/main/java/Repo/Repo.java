...
public class Repo implements IRepo {
    ...
    public void logPrgStateExec(PrgState state) throws MyException {
        try {
            ...
            logFile = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Diverse\\MAP\\InterpreterGUIBarrier\\"+fileName, true)));
            ...
            ICyclicBarrier<Integer, Pair<Integer, List<Integer>>> barrierTable = state.getBarrierTable();
            int id = state.getId();
            ...
            for (HashMap.Entry<Integer, Pair<Integer, List<Integer>>> e : barrierTable.getDict().entrySet()) {
                logFile.println("-> " + "Key: " + e.getKey().toString() + ", Value: " + e.getValue().toString());
            }
