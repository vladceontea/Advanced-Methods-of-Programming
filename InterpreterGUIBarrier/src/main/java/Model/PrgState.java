...
public class PrgState {
    ...
    ICyclicBarrier<Integer, Pair<Integer, List<Integer>>> barrierTable;
    IStmt originalProgram;
    int id;
    static int lastId = 0;

    public PrgState(IStack<IStmt> stk, IDict<String, IValue> symtbl, IList<IValue> ut, IDict<IValue, BufferedReader> filetab, IHeap<IValue> heaptbl, ICyclicBarrier<Integer, Pair<Integer, List<Integer>>> barriertbl, IStmt prg){
        this.exeStack = stk;
    ...
    public ICyclicBarrier<Integer, Pair<Integer, List<Integer>>> getBarrierTable(){
        return this.barrierTable;
    }

    public void setBarrierTable(ICyclicBarrier<Integer, Pair<Integer, List<Integer>>> barriertbl){
        this.barrierTable = barriertbl;
    }
