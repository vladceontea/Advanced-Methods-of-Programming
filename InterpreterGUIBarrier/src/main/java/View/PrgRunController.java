...
public class PrgRunController implements Initializable {
    ...
    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrierTableVariable;
    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrierTableValue;
    @FXML
    TableColumn<HashMap.Entry<Integer, Pair<Integer, List<Integer>>>, String> barrierTableIntegers;
    ...
    public void setBarrierTable(){
        ...
        barrierTableVariable.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getKey().toString()));
        barrierTableValue.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getValue().getFirst().toString()));
        barrierTableIntegers.setCellValueFactory(cellData -> new ReadOnlyStringWrapper(cellData.getValue().getValue().getSecond().toString()));
        barrierTableList.addAll(myController.getRepo().getPrgList().get(0).getBarrierTable().getDict().entrySet());
