...
public class PrgListController implements Initializable {
    ...
    public void setUp() {
        ...
        PrgState myPrgState1 = new PrgState(exeStack1, symTable1, out1, fileTable1, heapTable1, latchTable1, firstProgram);
        ...
        PrgState myPrgState2 = new PrgState(exeStack2, symTable2, out2, fileTable2, heapTable2, latchTable2, secondProgram);
        ...
        PrgState myPrgState3 = new PrgState(exeStack3, symTable3, out3, fileTable3, heapTable3, latchTable3, thirdProgram);
        ...
        PrgState myPrgState4 = new PrgState(exeStack4, symTable4, out4, fileTable4, heapTable4, latchTable4, fourthProgram);
        ...
        PrgState myLastPrgState = new PrgState(exeStack5, symTable5, out5, fileTable5, heapTable5, latchTable5, lastProgram);
