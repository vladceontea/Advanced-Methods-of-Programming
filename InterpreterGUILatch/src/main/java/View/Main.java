...
public class Main {
    ...
    // ex 1:  int v; v = 2; Print(v)
        ...
        ILatchTable<Integer, Integer> latchTable1 = new MyLatchTable<Integer, Integer>();
    ...
    // ex 2: a=2+3*5;b=a+1;Print(b)
        ...
        ILatchTable<Integer, Integer> latchTable2 = new MyLatchTable<Integer, Integer>();
    ...
    // ex 3: bool a; int v; a=true;(If a Then v=2 Else v=3);Print(v)
        ...
        ILatchTable<Integer, Integer> latchTable3 = new MyLatchTable<Integer, Integer>();
    ...
    // ex4: string varf; varf="test.in"; openRFile(varf); int varc; readFile(varf,varc); print(varc); readFile(varf,varc); print(varc); closeRFile(varf)
        ...
        ILatchTable<Integer, Integer> latchTable4 = new MyLatchTable<Integer, Integer>();
        ...
        */
        ...
        ILatchTable<Integer, Integer> latchTable5 = new MyLatchTable<Integer, Integer>();
        ...
        ILatchTable<Integer, Integer> latchTable6 = new MyLatchTable<Integer, Integer>();
        ...
        ILatchTable<Integer, Integer> latchTable10 = new MyLatchTable<Integer, Integer>();
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new HeapAllocStmt("v1", new ValueExp(new IntValue(2))),
                new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(new HeapAllocStmt("v2", new ValueExp(new IntValue(3))),
                        new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(new HeapAllocStmt("v3", new ValueExp(new IntValue(4))),
                                new CompStmt(new NewLatchStmt("cnt", new HeapReadExp(new VarExp("v2"))), new CompStmt(new ForkStmt(
                                        new CompStmt(new HeapWriteStmt("v1", new ArithExp('*', new HeapReadExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v1"))), new CompStmt(new CountDownStmt("cnt"), new ForkStmt(
                                        new CompStmt(new HeapWriteStmt("v2", new ArithExp('*', new HeapReadExp(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v2"))), new CompStmt(new CountDownStmt("cnt"), new ForkStmt(
                                                        new CompStmt(new HeapWriteStmt("v3", new ArithExp('*', new HeapReadExp(new VarExp("v3")), new ValueExp(new IntValue(10)))),
                                                                new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v3"))), new CountDownStmt("cnt")))))))))))),
        ...
        ILatchTable<Integer, Integer> latchTable11 = new MyLatchTable<Integer, Integer>();

        PrgState newProg1 = new PrgState(exeStack1, symTable1, out1, fileTable1, heapTable1, latchTable1, ex1);
        PrgState newProg2 = new PrgState(exeStack2, symTable2, out2, fileTable2, heapTable2, latchTable2, ex2);
        PrgState newProg3 = new PrgState(exeStack3, symTable3, out3, fileTable3, heapTable3, latchTable3, ex3);
        repo1.addPrg(newProg1);
        repo2.addPrg(newProg2);
        repo3.addPrg(newProg3);

        PrgState newProg4 = new PrgState(exeStack4, symTable4, out4, fileTable4, heapTable4, latchTable4, ex4);
        repo4.addPrg(newProg4);

        PrgState newProg5 = new PrgState(exeStack5, symTable5, out5, fileTable5, heapTable5, latchTable5, ex5);
        repo5.addPrg(newProg5);

        PrgState newProg6 = new PrgState(exeStack6, symTable6, out6, fileTable6, heapTable6, latchTable6, ex6);
        repo6.addPrg(newProg6);

        PrgState newProg10 = new PrgState(exeStack10, symTable10, out10, fileTable10, heapTable10, latchTable10, ex10);
        repo10.addPrg(newProg10);
        //ex10.typecheck(typeEnv);

        PrgState newProg11 = new PrgState(exeStack11, symTable11, out11, fileTable11, heapTable11, latchTable11, ex11);
