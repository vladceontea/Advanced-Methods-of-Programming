...
public class PrgListController implements Initializable {
    ...
    static Repo myFirstRepository, mySecondRepository, myThirdRepository, myFourthRepository, myLastRepository, semaphoreRepository;
    static Controller myFirstController, mySecondController, myThirdController, myFourthController, myLastController, semaphoreController;
    ...
    public void setUp() throws MyException {
        ...
        semaphoreRepository = new Repo("semaphoreProgramLog.txt");
        semaphoreController = new Controller(semaphoreRepository);
        ...
        IStmt semaphoreProgram = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(
                new HeapAllocStmt("v1", new ValueExp(new IntValue(1))), new CompStmt(new CreateSemaphoreStmt("cnt", new HeapReadExp(new VarExp("v1"))),
                new CompStmt(new ForkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new HeapWriteStmt("v1", new ArithExp('*', new HeapReadExp(new VarExp("v1")), new ValueExp(
                        new IntValue(10)))), new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v1"))), new ReleaseStmt("cnt"))))), new CompStmt(new ForkStmt(
                        new CompStmt(new AcquireStmt("cnt"), new CompStmt(new HeapWriteStmt("v1", new ArithExp('*', new HeapReadExp(new VarExp("v1")), new ValueExp(
                                new IntValue(10)))), new CompStmt(new HeapWriteStmt("v1", new ArithExp('*', new HeapReadExp(new VarExp("v1")), new ValueExp(
                                new IntValue(2)))), new CompStmt(new PrintStmt(new HeapReadExp(new VarExp("v1"))), new ReleaseStmt("cnt")))))), new CompStmt(
                        new AcquireStmt("cnt"), new CompStmt(new PrintStmt(new ArithExp('-', new HeapReadExp(new VarExp("v1")), new ValueExp(
                        new IntValue(1)))), new ReleaseStmt("cnt")))))))));
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable1 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState myPrgState1 = new PrgState(exeStack1, symTable1, out1, fileTable1, heapTable1, semaphoreTable1, firstProgram);
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable2 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState myPrgState2 = new PrgState(exeStack2, symTable2, out2, fileTable2, heapTable2, semaphoreTable2, secondProgram);
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable3 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState myPrgState3 = new PrgState(exeStack3, symTable3, out3, fileTable3, heapTable3, semaphoreTable3, thirdProgram);
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable4 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState myPrgState4 = new PrgState(exeStack4, symTable4, out4, fileTable4, heapTable4, semaphoreTable4, fourthProgram);
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable5 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState myLastPrgState = new PrgState(exeStack5, symTable5, out5, fileTable5, heapTable5, semaphoreTable5, lastProgram);
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable6 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();
        PrgState newProg6 = new PrgState(exeStack6, symTable6, out6, fileTable6, heapTable6, semaphoreTable6, semaphoreProgram);
        semaphoreRepository.addPrg(newProg6);
        semaphoreProgram.typecheck(typeEnv);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        myData.add(semaphoreController);
