...
public class Main {
    ...
    // ex4: string varf; varf="test.in"; openRFile(varf); int varc; readFile(varf,varc); print(varc); readFile(varf,varc); print(varc); closeRFile(varf)
        ...
        */
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable10 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();

        IStmt ex11 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(
        ...
        ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoreTable11 = new MySemaphore<Integer, Pair<Integer, List<Integer>>>();


        PrgState newProg1 = new PrgState(exeStack1, symTable1, out1, fileTable1, heapTable1, semaphoreTable1, ex1);
        PrgState newProg2 = new PrgState(exeStack2, symTable2, out2, fileTable2, heapTable2, semaphoreTable2, ex2);
        PrgState newProg3 = new PrgState(exeStack3, symTable3, out3, fileTable3, heapTable3, semaphoreTable3, ex3);
        repo1.addPrg(newProg1);
        repo2.addPrg(newProg2);
        repo3.addPrg(newProg3);

        PrgState newProg4 = new PrgState(exeStack4, symTable4, out4, fileTable4, heapTable4, semaphoreTable4, ex4);
        repo4.addPrg(newProg4);

        PrgState newProg5 = new PrgState(exeStack5, symTable5, out5, fileTable5, heapTable5, semaphoreTable5, ex5);
        repo5.addPrg(newProg5);

        PrgState newProg6 = new PrgState(exeStack6, symTable6, out6, fileTable6, heapTable6, semaphoreTable6, ex6);
        repo6.addPrg(newProg6);

        PrgState newProg10 = new PrgState(exeStack10, symTable10, out10, fileTable10, heapTable10, semaphoreTable10, ex10);
        repo10.addPrg(newProg10);
        ex10.typecheck(typeEnv);

        PrgState newProg11 = new PrgState(exeStack11, symTable11, out11, fileTable11, heapTable11, semaphoreTable11, ex11);
