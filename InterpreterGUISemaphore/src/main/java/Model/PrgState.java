...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDict<String, IValue> symtbl, IList<IValue> ut, IDict<IValue, BufferedReader> filetab, IHeap<IValue> heaptbl, ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoretbl, IStmt prg){
        this.exeStack = stk;
    ...
    public void setSemaphoreTable(ISemaphore<Integer, Pair<Integer, List<Integer>>> semaphoretbl){
        this.semaphoreTable = semaphoretbl;
    }
