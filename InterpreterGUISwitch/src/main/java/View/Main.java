...
public class Main {
    ...
    // ex4: string varf; varf="test.in"; openRFile(varf); int varc; readFile(varf,varc); print(varc); readFile(varf,varc); print(varc); closeRFile(varf)
        ...
        */
        ...
        IStmt ex11 = new CompStmt(new VarDeclStmt("a", new IntType()), new CompStmt(new VarDeclStmt("b", new IntType()), new CompStmt(
                new VarDeclStmt("c", new IntType()), new CompStmt(new AssignStmt("a", new ValueExp(new IntValue(1))), new CompStmt(
                new AssignStmt("b", new ValueExp(new IntValue(2))), new CompStmt(new AssignStmt("c", new ValueExp(new IntValue(5)))
                ...
                new PrintStmt(new VarExp("b"))), new ValueExp(new IntValue(10)), new CompStmt(new PrintStmt(new ValueExp(new IntValue(100))),
                new PrintStmt(new ValueExp(new IntValue(200)))), new PrintStmt(new ValueExp(new IntValue(300)))), new PrintStmt(new ValueExp(new IntValue(300))))))))));
        ...
        PrgState newProg1 = new PrgState(exeStack1, symTable1, out1, fileTable1, heapTable1, ex1);
        PrgState newProg2 = new PrgState(exeStack2, symTable2, out2, fileTable2, heapTable2, ex2);
        PrgState newProg3 = new PrgState(exeStack3, symTable3, out3, fileTable3, heapTable3, ex3);
        repo1.addPrg(newProg1);
        repo2.addPrg(newProg2);
        repo3.addPrg(newProg3);

        PrgState newProg4 = new PrgState(exeStack4, symTable4, out4, fileTable4, heapTable4, ex4);
        repo4.addPrg(newProg4);

        PrgState newProg5 = new PrgState(exeStack5, symTable5, out5, fileTable5, heapTable5, ex5);
        repo5.addPrg(newProg5);

        PrgState newProg6 = new PrgState(exeStack6, symTable6, out6, fileTable6, heapTable6, ex6);
        repo6.addPrg(newProg6);

        PrgState newProg10 = new PrgState(exeStack10, symTable10, out10, fileTable10, heapTable10, ex10);
        repo10.addPrg(newProg10);
        ex10.typecheck(typeEnv);

        PrgState newProg11 = new PrgState(exeStack11, symTable11, out11, fileTable11, heapTable11, ex11);
