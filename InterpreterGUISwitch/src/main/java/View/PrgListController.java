...
public class PrgListController implements Initializable {
    ...
    static Repo myFirstRepository, mySecondRepository, myThirdRepository, myFourthRepository, myLastRepository, switchRepository;
    static Controller myFirstController, mySecondController, myThirdController, myFourthController, myLastController, switchController;
    ...
    public void setUp() {
        ...
        switchRepository = new Repo("switchProgramLog.txt");
        switchController = new Controller(switchRepository);
        ...
        IStmt switchProgram = new CompStmt(new VarDeclStmt("a", new IntType()), new CompStmt(new VarDeclStmt("b", new IntType()), new CompStmt(
        ...
        PrgState switchPrgState = new PrgState(exeStack6, symTable6, out6, fileTable6, heapTable6, switchProgram);
        switchRepository.addPrg(switchPrgState);
    }
