...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDict<String, IValue> symtbl, IList<IValue> ut, IDict<IValue, BufferedReader> filetab, IHeap<IValue> heaptbl, ILockTable<Integer, Integer> locktbl,IStmt prg){
        this.exeStack = stk;
    ...
    public void setLockTable(ILockTable<Integer, Integer> locktbl){
        this.lockTable = locktbl;
    }
