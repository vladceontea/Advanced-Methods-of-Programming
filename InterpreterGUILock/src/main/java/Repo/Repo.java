...
public class Repo implements IRepo {
    ...
    public void logPrgStateExec(PrgState state) throws MyException {
        try {
            ...
            logFile = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Diverse\\MAP\\InterpreterGUILock\\"+fileName, true)));
            ...
            for (HashMap.Entry<Integer, Integer> e : lockTable.getContent().entrySet()) {
                logFile.println("-> " + "Key: " + e.getKey().toString() + ", Value: " + e.getValue().toString());
            }
            logFile.println("------------------------------------------");
            logFile.close();
